...
<head>
	...
	$(document).ready(function(){
		...
		websocket.onmessage = function(event) {
            ...
            //He added this if statement so that the message only sends if the room number the user is on is == 1
		...
		$('#frmChat').on("submit",function(event){
			...
			var messageJSON = {
			    //He added roomNumber as a variable here
                roomNumber:1,
  ...
  <div style="margin-left:15%; margin-right:15%; background-color:#333; opacity: 0.9; height: 100%;">
    ...
    <center><h1  style="text-align: center; background-color:white; opacity:0.5;width:70%;">Public</h1></center>
