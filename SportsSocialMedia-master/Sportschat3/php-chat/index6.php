...
<div class="topnav">
    ...
    ?>
	<a href="../index1.php" style="width:900px; background-color: black;">Private Chat</a>
...
<div style="margin-left:15%; margin-right:15%; background-color:#333; opacity: 0.9; height: 100%;">
    ...
    <center><h1 style="text-align: center; background-color:white; opacity:0.5;width:70%;">AFC South/West</h1></center>
    ...
    <div style="padding-left: 20%; padding-right: 20%">
        <form name="frmChat" id="frmChat">
            <div id="chat-box"></div>
            <input style = "color:#333;"type="text" name="chat-user" id="chat-user" placeholder="Name" value="<?php echo $user_data['user_name'] ?>" class="chat-input" disabled />
